/* a)Escribir una función recursiva sumAll que reciba una lista de enteros y retorne la suma de sus elementos.*/
/*Escribir una función recursiva odds que reciba una lista de enteros y retorne 1 si todos sus elementos son impares, 
y cero si no. Escribir dos versiones:
