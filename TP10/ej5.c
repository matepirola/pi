/*Escribir la función recursiva restaList que reciba únicamente dos listas de enteros ordenadas en forma ascendente 
y sin repetidos, y retorne una nueva lista ordenada y sin repetidos con los elementos de la primer lista que no están 
en la segunda lista.*/
