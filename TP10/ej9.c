/*Escribir la función recursiva comprimeList que reciba una lista ordenada donde cada elemento es menor o 
igual al siguiente (puede tener repetidos), y retorne una nueva lista de tipo TListBrief ordenada donde en 
cada nodo se indica la cantidad de veces que aparece el elemento.
Ejemplo:
