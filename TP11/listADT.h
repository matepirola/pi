...
// Agregar al TAD de listas genéricas provisto por la Cátedra una función que reciba un número entero i 
//y devuelve el i-ésimo elemento, donde el primer elemento tiene el índice cero.


int posicionElement(listADT aux, int i);
