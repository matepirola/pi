...
Se dice que una fila A está contenida en la fila B si todos los elementos de A (sin importar el orden y repetición) 
están en la fila B. Por ejemplo la fila {1,3,1,4} está contenida en la fila {2,3,4,1}, la fila {1,1,1,1} está contenida 
en la fila {3,1,4,5}
